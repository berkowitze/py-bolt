# dependencies: python-pptx, openpyxl (can use pip install for both)
# once you have these packages, make sure the parameters below are correct,
# then run `python bolt-cards.py`
# if there's a bug that you don't know how to fix, email me at:
...
#
# you must also have a spreadsheet with transfer students' names,
# first names in one column and last names in another. Make sure the
# names match up with the names in the main spreadsheet
...
print 'Cards saved to "%s".' % output_pptx
